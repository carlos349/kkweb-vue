                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form row">
                            ...
                            <fg-input class="col-6 mb-4 mt-3" placeholder="Tu nombre" v-model="name" addon-right-icon="now-ui-icons users_single-02"></fg-input>
                            <fg-input class="col-6 mb-4 mt-3" placeholder="Tu apellido" v-model="lastName" addon-right-icon="now-ui-icons users_single-02"></fg-input>
                            <fg-input class="col-12 mb-4" placeholder="Asunto" v-model="subject" addon-right-icon="now-ui-icons     text_caps-small"></fg-input>
                            <fg-input class="col-12 mb-4" placeholder="Mensaje" v-model="message" addon-right-icon="now-ui-icons ui-1_email-85"></fg-input>
                            <n-button class="mt-4 ml-3" type="primary" size="lg" >Contactar</n-button>
                        </div>
                    </div>
                </div>
            </div>
