          ...
          <div class="col-md-4 mt-2" data-aos="fade-up">
            <vue-flip active-hover width="100%" height="40vh">
              ...
              <template v-slot:back class="back">
                ...
                <center>
                  <n-button type="default" size="lg" @click="modals.modal1 = true, servicio ='Manicure tradicional', servicio2=' +',servicio3='Pedicure tradicional',precio='15.000'">REGALAR</n-button>
                </center>
              </template>
            </vue-flip>
          </div>
          <div class="col-md-4 mt-2" data-aos="fade-up">
            <vue-flip active-hover width="100%" height="40vh">
              ...
              <template v-slot:back class="back">
                ...
                <center>
                  <n-button type="default" size="lg" @click="modals.modal1 = true, servicio ='Manicure permanente', servicio2=' +',servicio3='Ondulación de pestañas',precio='26.500'">REGALAR</n-button>
                </center>
              </template>
            </vue-flip>
          </div>
          <div class="col-md-4 mt-2" data-aos="fade-up">
            <vue-flip active-hover width="100%" height="40vh">
              ...
              <template v-slot:back class="back">
                ...
                <center>
                  <n-button type="default" size="lg" @click="modals.modal1 = true, servicio ='Manicure permanente', servicio2=' +',servicio3='Pedicure permanente',precio='27.000'">REGALAR</n-button>
                </center>
              </template>
            </vue-flip>
          </div>
          <div class="col-md-4 mt-2" data-aos="fade-up">
            <vue-flip active-hover width="100%" height="40vh">
              ...
              <template v-slot:back class="back">
                ...
                <center>
                  <n-button type="default" size="lg" @click="modals.modal1 = true, servicio ='Manicure permanente', servicio2='',servicio3='',precio='12.000'">REGALAR</n-button>
                </center>
              </template>
            </vue-flip>
          </div>
          <div class="col-md-4 mt-2" data-aos="fade-up">
            <vue-flip active-hover width="100%" height="40vh">
              ...
              <template v-slot:back class="back">
                ...
                <h4 style="margin-top:-5px;font-weight:700;color:#000;" class="text-center"><i class="now-ui-icons business_money-coins" style="color:#77a464;"></i> 15.000</h4>
                <center>
                  <n-button type="default" size="lg" @click="modals.modal1 = true, servicio ='Ondulación con tinte', servicio2='',servicio3='',precio='15.000'">REGALAR</n-button>
                </center>
              </template>
            </vue-flip>
          </div>
          <div class="col-md-4 mt-2" data-aos="fade-up">
            <vue-flip active-hover width="100%" height="40vh">
              ...
              <template v-slot:back class="back">
                ...
                <center>
                  <n-button type="default" size="lg" @click="modals.modal1 = true, servicio ='Ondulación sin tinte', servicio2='',servicio3='',precio='13.000'">REGALAR</n-button>
                </center>
              </template>
            </vue-flip>
          </div>
               ...
               <div class="row">
                 ...
                 <div class="col-sm-6">
                   ...
                   <div style="display:none">
                     <login data-aos="zoom-in-up" data-aos-duration="1000" v-if="showFormGift == 'login'">
