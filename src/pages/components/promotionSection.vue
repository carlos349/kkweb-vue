<template>
  <div class="section">
    <div class="container">
        <h2 class="titlesPrada text-center" data-aos="fade-up">PROMOCIONES</h2>
        <div class="row">
          <div class="col-md-4">
            <div class="w-75 mx-auto pb-4">
              <center>
                ...
                <a href="http://kkspa.syswa.net/#/agendamientoCliente" target="_blank"> <n-button data-aos="fade-up" type="default" size="lg">AGENDA TU SERVICIO</n-button></a>
              </center>
            </div>
          </div>
          <div class="col-md-4" style="background-color:#faf7ef;">
            <div class="w-75 mx-auto pb-4">
              <center>
                ...
                <n-button data-aos="fade-up" type="default" size="lg" disabled>DESHABILITADO</n-button>
              </center>
            </div>
          </div>
          <div class="col-md-4">
