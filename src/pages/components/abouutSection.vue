  ...
  <div class="section estePs" style="background-image: url('img/intro.jpg');margin-top:-170px;">
    <div class="container">
        <div class="row justify-content-end">
          <div class="col-md-6">
            <h2 data-aos="fade-up" class="opacity-cero titlesPrada">KK SPA</h2>
            ...
            <br><br>
            Es por esto y muchas razones más que en KK SPA hacemos nuestro trabajo con cariño y buscamos cada día profesionalizar más y garantizar que cada minuto en nuestro local sea satisfactorio.
            </p>
